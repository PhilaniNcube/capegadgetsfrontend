  ...
  categories: [
    {
      ...
      featured: [
        ...
        },
        {
          ...
          imageSrc: '/images/asista.jpg',
          imageAlt: 'Aux and Bluetooth Headphones',
        },
      ],
      sections: [
        {
          ...
          items: [
            ...
            { name: 'Cables', href: '/categories/cables' },
            { name: 'Calculators', href: '/categories/calculators' },
            { name: 'Earphones', href: '/categories/earphones' },
            { name: 'Headphones', href: '/categories/headphones' },
            { name: 'Hard Drives', href: '/categories/hard-drives' },
...

        {
          ...
          items: [
            ...
            { name: 'Amplify', href: '/brands/amplify' },
            { name: 'Casio', href: '/brands/casio' },
            { name: 'Connex', href: '/brands/connex' },
...
export default function Navbar() {
  ...
  return (
    <div className="bg-gray-200 z-30">
      {/* Mobile menu */}
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          ...
          >
            <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto z-30">
              ...
              <Tab.Group as="div" className="mt-2">
                ...
                <Tab.Panels as={Fragment}>
                  {navigation.categories.map((category) => (
                    <Tab.Panel
                      key={category.name}
                      className="pt-10 pb-8 px-4 space-y-10 z-30"
                    >
                      <div className="grid grid-cols-2 gap-x-4">
                        {category.featured.map((item) => (
                          ...
                          >
                            ...
                            <Link href={item.href}>
                              <a className="mt-6 block font-semibold text-gray-900">
                                <span
      ...
      <header className="relative bg-white">
        <p className="bg-indigo-600 h-10 flex items-center justify-center text-sm font-medium text-white px-4 sm:px-6 lg:px-8">
          To purchase using Eduloan Contact us 073 206 2822
        </p>
